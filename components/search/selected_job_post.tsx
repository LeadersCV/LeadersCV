    ...
    <section className={classes.container}>
      <div className={classes.header}>
        ...
        <div className={classes.actionButtons}>
          {props.hasApplied ? (
            <div className={classes.hasApplied}>
              You applied<br></br>2 days ago
            </div>
          ) : (
            <Button
              variant="contained"
      ...
      <Accordion TransitionProps={{ unmountOnExit: true }}>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography className={classes.question}>Job Description</Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      <Accordion TransitionProps={{ unmountOnExit: true }}>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography className={classes.question}>Job Requirements</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography className={classes.content}>
            {" "}
